...
var SYSTEM_PROMPT = [
  ...
  '',
  '【决策原则】',
  '1. 收自己能量：看到自己森林有可收能量球时，用 call_sub collect_own_energy（图像识别精确定位），',
  '   不要自己 click 坐标（凭截图猜能量球位置误差大，常点空）。',
  '2. 当前页无可收时，swipe 向下滑动找更多，或 call_sub stroll 逛好友。',
  '3. 弹窗/H5 优先关闭返回主流程（用无障碍树给的关闭按钮真实坐标）。',
  '4. 不确定时 wait，不要乱点。',
  '5. 收集完成（没能量球了）返回 finish。'
].join('\n')
